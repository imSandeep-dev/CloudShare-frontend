...
import { Copy, Download, Eye, File, FileIcon, FileText, Globe, Grid, Image, List, Lock, Trash2, Video } from "lucide-react"
...
const MyFiles = () => {
    ...
    const handleDelete = async (fileId) => {
        ...
        try {
            ...
            console.error("Error occured to delete file")
    ...
    const getFileIcon = (file) => {
        ...
        if(['pdf','csv','doc','docx','txt','rtf'].includes(extension)){
            return <FileText size={24} className="text-amber-500"/>
        }
        return <FileIcon size={24} className="text-purple-500"/>
    }

    const handlePreviewUrl = async(fileId) => {
        try{
            const token = await getToken()
            const response = await axios.get(apiEndpoints.GET_VIEW_URL(fileId),{headers:{Authorization:`Bearer ${token}`}})
        ...
        <DashboardLayout activeMenu="My Files">
            <div className="p-6">
                ...
                {files.length===0 ? (
                    <div className="bg-white rounded-lg shadow p-12 flex flex-col items-center justify-center ">
                        ...
                        <p className="text-gray-500 text-center mb-6 max-w-md">
                            ...
                            documents, images and other files to share and manange them securely.
                        </p>
                        <button 
                            ...
                            <table className="min-w-full">
                                <thead className="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium  uppercase tracking-wider">Sharing</th>
                                        ...
                                        <tr key={file.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div className="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div className="flex justify-center">
                                                        {file.isPublic ? (
                                                            <Eye size={18} onClick={() => handlePreviewUrl(file.id)}/>
                                                        ) : (
                ...
                <ConfirmationDialog isOpen={deleteConfirmation.isOpen} 
                    ...
                    confirmText="Delete"
                    cancelText="Cancel"
                    onConfirm={()=>handleDelete(deleteConfirmation.fileId)}
